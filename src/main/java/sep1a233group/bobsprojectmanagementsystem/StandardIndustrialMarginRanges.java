...
public class StandardIndustrialMarginRanges {
  ...
  // Constructor
  public StandardIndustrialMarginRanges(double budgetFloor, double budgetCeiling, int projectDurationFloor, int projectDurationCeiling) {
  ...
  public String toString() {
    return "StandardIndustrialMarginRanges{" +
